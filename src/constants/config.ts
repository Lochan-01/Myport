...
export const config: TConfig = {
  html: {
    ...
    fullName: "Lochan S",
    email: "lochan1310.s@mail.com",
  },
  hero: {
    name: "Lochan S",
    p: ["Creative thinker and full-stack developer building modern web applications.", "I turn ideas into intelligent, scalable solutions using modern technologies."],
  },
  contact: {
    p: "Get in touch",
    h2: "Contact.",
  ...
  sections: {
    about: {
      p: "Introduction",
      h2: "Overview.",
      content: `I'm a software engineer and full-stack developer skilled in building scalable web applications and intelligent systems. I enjoy turning creative ideas into efficient, user-friendly solutions using modern technologies.`,
    },
    experience: {
      p: "My work",
      h2: "Projects.",
